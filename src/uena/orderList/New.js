...
const New = ({ data }) => {
  return (
    <Table
      tableId="#orderList_new tbody tr"
      sort={3}
      numberCountId="#orderList_new_info"
      pagginationContainerId="#orderList_new_paginate"
      // create
      ...
      previousBtnId="orderList_new_previous"
      nextBtnId="orderList_new_next"
      pagginationId="orderList_new_paggination"
      activeClass="current"
    >
      <div className="table-responsive rounded table-hover">
        <div id="orderList_new" className="dataTables_wrapper no-footer">
          <table
            className="table text-black card-table mb-4 table-responsive-lg dataTablesCard dataTable no-footer"
            id="orderList_new"
            role="grid"
            aria-describedby="orderList_new_info"
          >
          ...
          <div className="d-sm-flex text-center justify-content-between align-items-center">
            <div
              ...
              id="orderList_new_info"
              role="status"
              aria-live="polite"
            ></div>
            <div
              className="dataTables_paginate paging_simple_numbers"
              id="orderList_new_paginate"
            ></div>
          </div>
        </div>
      </div>
