...
const Distribute = () => {
  ...
  const handleDistribute = async() => {
    ...
    try {
      ...
      const tx = await FGOLTokenContract.methods.approve(addressOfFGOLDistribution, distributeValueWei).send({ from: walletAddress, gasPrice, nonce })
      console.log(tx)
      ...
      const res = await FGOLDistributionContract.methods.allocateForDistribution(distributeValueWei).send({from: walletAddress, gasPrice, nonce});
      console.log(res)
