    ...
    <Box backgroundColor='#041431' position='fixed' top={0} left={0} right={0} bottom={0} sx={{overflowY:'auto'}}>
      <Box px={{ xs:3, sm:10 }} position='relative' backgroundColor='#1C1C39' maxWidth={550} pt={10} minHeight='100vh' pb={4} margin='auto'>
        ...
        <Grid container justifyContent='space-between' gap={1}>
          <Button onClick={handleBuyFGOLClick} variant="contained" sx={{borderRadius:5, fontSize:'17px!important', backgroundColor:'#2683F6!important', width:{xs:'100%', sm:'170px'}}} size='small'>BUY FGOL</Button>
          <Button onClick={handleBuyFGOLClick} variant="contained" sx={{borderRadius:5, fontSize:'17px!important', backgroundColor:'#041431!important', width:{xs:'100%', sm:'170px'}}} size='small'>STAKING FGOL</Button>
        </Grid>
      </Box>
